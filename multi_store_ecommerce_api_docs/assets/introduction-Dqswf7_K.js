import{O as i,j as e}from"./entry.client-D-ZNNWX7.js";const s="Welcome to the official documentation for the Multi Store E-Commerce API. This RESTful API powers our multi-vendor e-commerce platform, allowing developers to integrate with our system for various operations including user management, product listings, order processing, and more.",d=[{depth:2,value:"API Overview",id:"api-overview"},{depth:2,value:"Authentication",id:"authentication"},{depth:2,value:"Error Handling",id:"error-handling"},{depth:2,value:"Getting Started",id:"getting-started"}],c={title:"Multi Store E-Commerce API",description:"Documentation for the Multi Store E-Commerce RESTful API"};function r(t){const n={code:"code",h2:"h2",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.p,{children:"Welcome to the official documentation for the Multi Store E-Commerce API. This RESTful API powers our multi-vendor e-commerce platform, allowing developers to integrate with our system for various operations including user management, product listings, order processing, and more."}),`
...
//# sourceMappingURL=introduction-Dqswf7_K.js.map
